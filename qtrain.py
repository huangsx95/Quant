...
qat_model = load_model(saved_model_dir + float_model_file).to('cuda:0')
...
for nepoch in range(20):
    train_one_epoch(qat_model, criterion, optimizer, data_loader, torch.device('cuda:0'), num_train_batches)
    if nepoch > 3:
